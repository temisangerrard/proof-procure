        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/login">
              <Button
                size="lg"
                className="h-10 bg-white px-4 text-slate-950 hover:bg-slate-100"
              >
                Sign in
              </Button>
            </Link>
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {audiences.map((item) => (
                <span
                  key={item}
                  className="rounded-full bg-white/8 px-3 py-1.5 text-sm font-medium text-slate-300 ring-1 ring-white/10"
                >
                  {item}
                </span>
              ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, index) => (
            <div
              key={step.title}
              className="rounded-2xl bg-white p-5 shadow-[0_18px_55px_rgba(15,23,42,0.08)] ring-1 ring-slate-200"
            >
            ...
            <div className="flex items-center gap-3 border-b border-slate-100 pb-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Use money you do not need today.
                </p>
              </div>
            </div>
...
function PreviewBill({
  ...
  return (
    <div className="flex items-center justify-between border-b border-slate-100 p-4 last:border-b-0">
      ...
      <span
        className={`rounded-full px-3 py-1 text-sm font-semibold ${warning ? "bg-rose-50 text-rose-700" : "bg-emerald-50 text-emerald-700"}`}
      >
        {state}
      </span>
    </div>
