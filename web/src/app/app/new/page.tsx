    ...
    <div className="max-w-2xl space-y-6">
      ...
      {loading ? (
        ...
        <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          ...
          <h2 className="mt-5 text-2xl font-semibold tracking-tight">Add a supplier first</h2>
        ...
        <form onSubmit={submit} className="space-y-4 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <label className="grid gap-2">
            <span className="text-sm font-semibold text-slate-700">Pay date</span>
            <Input
              className="h-14 rounded-2xl px-4 text-lg"
              type="date"
              value={dueDate}
          ...
          <Button type="submit" disabled={saving || !supplierId || !amount} className="h-12 gap-2 px-5">
