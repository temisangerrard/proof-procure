...
const PROFILE = [
  ...
  { label: "Supplier countries", value: "China, Turkey, India, Vietnam", icon: Globe2 },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-slate-950 p-5 text-white">
        <p className="text-sm font-medium text-emerald-300">Behind the scenes</p>
        <h2 className="mt-2 text-xl font-semibold">Simple outside. Fast inside.</h2>
