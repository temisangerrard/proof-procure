...
import { createCircleWalletChallenge, listCircleWallets } from "@/lib/circle-user-controlled";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : "Could not initialize wallet";
